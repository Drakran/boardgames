<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"
	import="java.util.List, java.util.ArrayList, boardgame.Meet"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
	...
	<form action="createMeetup" method="GET">
		<div class="form-group">
			<label for="gameName">Game Name</label> <input type="text"
				name="gameName" class="form-control" id="gameName"
				placeholder="Enter a game name">
		</div>
		<div class="form-group">
			<label for="meetTime">Meet Time</label> <input type="text"
				name="meetTime" class="form-control" id="meetTime"
				placeholder="Enter a time to meet">
		</div>
		<div class="form-group">
			<label for="frequency">Frequency</label> <input type="text"
				name="frequency" class="form-control" id="frequency"
				placeholder="Enter how often you'd like to meet">
		</div>
		<div class="form-group">
			<label for="description">Capacity</label> <input type="number"
				name="capacity" class="form-control" id="description"
